<?php
        ...
        if($_SESSION)
        {
            ...
            $ad = $cashier->getCashierById($_GET['id'])
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
                                ...
                                <div class="sttabs tabs-style-shape">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#section-shape-5">
                                                    ...
                                                    <span>(Cashier)<?php echo $_SESSION['cashier'];?></span>
                                                </a>
                                            </li>
                                        </ul>
                                    </nav>
                                    <div class="content-wrap">
                                        ...
                                        <section id="section-shape-2">
                                            <div class="row">                                
                                                <div class="col-md-4">
                                                        <div class=""><a href="cart.php?id=<?php echo $_GET['id'];?>">Cart</a></div>
                                                    <div class="table-responsive">
                                                        <table id="example24" class="display nowrap" cellspacing="0" width="100%">
                                                            ...
                                                            <tbody>
                                                                <?php foreach($in as $n){?>
                                                                <tr>
                                                                    <td><?php echo $n['inven_id'];?></td>
                                                                    <td><?php echo $n['inven_name'];?></td>
                                                                    <td><?php echo $n['inven_quantity'];?></td>
                                                                    <td><?php echo $n['inven_desc'];?></td>
                                                                    <td><?php echo $n['inven_price'];?></td>
                                                                </tr>
                                                                <?php }?>
                                                            </tbody>
                                                        </table>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="table-responsive">
                                                        <table id="example25" class="display nowrap" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    <?php foreach($prod as $n){?>
                                                                    <tr>
                                                                        <td><?php echo $n['prod_id'];?></td>
                                                                        <td><?php echo $n['prod_name'];?></td>
                                                                        <td><?php echo $n['prod_quantity'];?></td>
                                                                        <td><?php echo $n['prod_desc'];?></td>
                                                                        <td><?php echo $n['prod_price'];?></td>
                                                                        <td>
                                                                            <form action="../../controller/Inventory/cartController.php?id=<?php echo $_GET['id'];?>" method="post">
                                                                            <input type="text" hidden name='code' value='<?php echo $n['prod_id'];?>'>
                                                                            <input type="text" hidden name='name' value='<?php echo $n['prod_name'];?>'>
                                                                            <input type="text" hidden name='quantity' value='<?php echo $n['prod_quantity'];?>'>
                                                                            <input type="text" hidden name='desc' value='<?php echo $n['prod_desc'];?>'>
                                                                            <input type="text" hidden name='price' value='<?php echo $n['prod_price'];?>'>
                                                                            <button type="submit" class="btn btn-primary" name="addCart">Add Cart</button>
                                                                            </form>
                                                                        </td>
                                                                    </tr>
                                                                    <?php }?>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-9">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control" type="text" value="<?php echo $ad['cashier_lastname'];?>" name="lastname" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-9">
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="ti-user"></i></div>
                                                                        <input class="form-control" type="text" value="<?php echo $ad['cashier_firstname'];?>" name="firstname" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-9">
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="ti-user"></i></div>
                                                                        <input class="form-control" type="text" value="<?php echo $ad['cashier_mi'];?>" name="mi" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-9">
                                                                    <div class="input-group">
                                                                            <div class="input-group-addon"><i class="ti-user"></i></div>
                                                                            <input class="form-control" type="username" value="<?php echo $ad['cashier_username'];?>" name="username" required placeholder="Username">
